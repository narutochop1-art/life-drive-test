...
$('start').onclick=()=>{i=0;a=[];ev('test_start');show('quiz');render()};$('quit').onclick=()=>show('home');$('invite').onclick=shareInvite;$('restart').onclick=()=>show('home');$('again').onclick=()=>show('home');$('shareResult').onclick=shareResultImage;$('shareFullResult').onclick=shareResultImage;$('closeShareModal').onclick=closeShareImageModal;$('shareModalBackdrop').onclick=closeShareImageModal;$('saveShareImage').onclick=saveCurrentShareImage;
